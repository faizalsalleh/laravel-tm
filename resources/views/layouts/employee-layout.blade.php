...
<body>
    <div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <svg class="nav-icon">
                        <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons@3.0.1/sprites/free.svg#cil-task"></use>
                    </svg> Result
                </a>
            </li>
        </ul>
    ...
    <div class="wrapper d-flex flex-column min-vh-100">
                ...
                <ul class="header-nav ms-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            <div class="dropdown-header bg-body-tertiary text-body-secondary fw-semibold rounded-top mb-2">My Account</div>
        ...
        <footer class="footer px-4 bg-white border-top">
            ...
            <div class="ms-auto text-secondary small">Employee Portal</div>
        </footer>
    </div>
